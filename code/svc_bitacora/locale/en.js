const crudMessages = {
  ...
  ProcessingQueueItem: "Processig queue item ",
  LogSuccessfullyProcessed: "Log successfully processed ",
  LogProcessFail: "Failed to process queue item: ",
  UnableToSaveLog: "Unable to save log",
  UnableToRetrive: "Not able to process the request",
  DateIsMissing: "Must provide dates to perform the search",
};
